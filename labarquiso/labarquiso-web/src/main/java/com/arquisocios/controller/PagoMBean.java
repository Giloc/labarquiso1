 ...
 */
package com.arquisocios.controller;

import com.arquisocios.entity.Pago;
import com.arquisocios.session.PagoManagerLocal;
...
public class PagoMBean implements Serializable {
    ...
    public String save(){
        ...
        String fecha_pago=day+"-"+month+"-"+year;
    ...
    public void validarTarjeta(){
        if(num_tar.length() >= 5){
            ...
            }else if(num>=33334 && num<=44444){
                tipo_tar="DINERS";
                this.imagenTarj="Img/tarjetas/diners.png";
            }else if(num>=55555&& num<=66666){
                tipo_tar="VISA";
                this.imagenTarj="Img/tarjetas/visa.png";
            }else if( num>=77777 && num<=88888){
                tipo_tar="MASTERCARD";
